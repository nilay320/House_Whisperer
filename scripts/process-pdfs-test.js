...
// Process PDFs - TEST VERSION (SOP files only)
async function processPDFs() {
  // ONLY process SOP directory for testing
  const pdfDirs = [
  ...
  console.log(`\n🎉 TEST COMPLETE! Processed ${pointId} total chunks`);
  return pointId;
}

// Main function
async function main() {
  console.log('🧪 Starting PDF TEST ingestion (SOP files only)...\n');
  ...
  try {
    ...
    console.log('3. If working, run full ingestion later');
