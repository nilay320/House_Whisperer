  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Save the selected role for the user
        if (selectedRole && result.user) {
          console.log('🔥 Saving role to Firestore:', selectedRole, 'for user:', result.user.uid);
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Home Inspector AI</h1>
          </div>
          <p className="text-gray-600">
            🚀 NEW VERSION - Choose your role and sign in with Google to get started
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="text-xs mt-1">Conduct inspections</div>
            </button>
            <button
              type="button"
